                    ...
                    foreach ($groupedProducts as $groupedProduct):
                        ...
                        <tbody>
                            <?php foreach ($sizes as $size): ?>
                                ...
                                <!-- edit quantity modal -->
                                <div class="modal fade" id="editQuantityModal<?= $product->getId() ?>_<?= $size->getSizeId() ?>"
                                        ...
                                        <div class="modal-content">
                                            <form id="form_<?= $product->getId() ?>_<?= $size->getSizeId() ?>">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <label for="inputQuantity" class="form-label">Current Quantity</label>
                                                    <input type="number" name="inputQuantity" id="inputQuantity"
                                                        class="form-control" value="<?= $size->getQuantity() ?>" readonly>

                                                    <label for="inputNewQuantity" class="form-label">New Quantity</label>
                                                    <input type="number" name="inputNewQuantity" id="inputNewQuantity"
                                                        class="form-control">
